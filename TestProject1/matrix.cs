...
namespace Matrix1
{
    class Program
    {
        public class RMatrix
        {
            ...
            public static RMatrix operator --(RMatrix mt)
            {
                RMatrix result = new RMatrix(mt.GetnRows);
                for (int rowIndex = 0; rowIndex < mt.GetnCols; ++rowIndex)
                {
                    for (int colIndex = 0; colIndex < mt.GetnRows; ++colIndex)
                    {
            ...
            public static RMatrix operator +(RMatrix m1, RMatrix m2)
            {
                ...
                RMatrix result = new RMatrix(m1.GetnRows);
                for (int i = 0; i < m1.GetnRows; i++)
                {
                    for (int j = 0; j < m1.GetnCols; j++)
                    {
            ...
            {
                RMatrix result = new RMatrix(m.GetnRows);
